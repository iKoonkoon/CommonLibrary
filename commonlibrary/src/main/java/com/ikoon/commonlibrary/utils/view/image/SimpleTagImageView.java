package com.ikoon.commonlibrary.utils.view.image;
...
public class SimpleTagImageView extends AppCompatImageView
{
    ...
    public SimpleTagImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTagWidth = a.getDimensionPixelSize(R.styleable.SimpleTagImageView_simple_tag_width, DimenUtils
                .dpToPxInt(DEFAULT_TAG_WIDTH));
