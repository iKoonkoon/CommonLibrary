...
public class StatusBarUtil
{
    ...
    public static final int ENVIOR_DEFAULT_STATUS_BAR_ALPHA = 60;
     ...
     * @return
     */
    public static void setbackground(View viewStatus, int drawable)
    {
        LinearLayout.LayoutParams lp = (LinearLayout.LayoutParams) viewStatus.getLayoutParams();
        lp.width = LinearLayout.LayoutParams.MATCH_PARENT;
        lp.height = StatusBarUtil.getStatusBarHeight();
        viewStatus.setLayoutParams(lp);
        viewStatus.setBackground(AppUtils.getResource().getDrawable(drawable));
    }
    ...
    {
        Resources resources = AppUtils.getResource();
