package com.ikoon.commonlibrary.utils.network;
...
import com.ikoon.commonlibrary.utils.log.LogUtils;
...
public class NetworkUtils
{
    ...
    public static void openWirelessSettings()
    {
        ...
        } else
        {
            ...
            AppUtils.getApp().startActivity(new Intent().setComponent(component).setAction("android.intent.action.VIEW"));
        }
    }
    ...
    public static boolean getWifiEnabled()
    {
        ...
        WifiManager manager = (WifiManager) AppUtils.getApp().getSystemService(Context.WIFI_SERVICE);
