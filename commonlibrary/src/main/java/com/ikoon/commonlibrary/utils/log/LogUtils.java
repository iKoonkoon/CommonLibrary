package com.ikoon.commonlibrary.utils.log;

import android.content.Context;
import android.os.Environment;
import android.util.Log;

import com.ikoon.commonlibrary.BuildConfig;
...
public class LogUtils
{
    ...
    private static String LOG_TAG = "exsun_log"; // 默认的tag
    ...
    { // 在Application中初始化
        LOG_FILE_PATH = Environment.getExternalStorageDirectory().getPath() + File.separator + AppUtils
