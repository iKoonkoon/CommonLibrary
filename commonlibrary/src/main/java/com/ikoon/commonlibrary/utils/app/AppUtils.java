...
import com.ikoon.commonlibrary.utils.encrypt.EncryptUtils;
import com.ikoon.commonlibrary.utils.io.FileUtils;
import com.ikoon.commonlibrary.utils.other.CleanUtils;
import com.ikoon.commonlibrary.utils.other.IntentUtils;
import com.ikoon.commonlibrary.utils.other.ProcessUtils;
import com.ikoon.commonlibrary.utils.other.ShellUtils;
...
public class AppUtils
{
    ...
    public static void installApp(final File file, final String authority)
    {
        ...
        mContext.startActivity(IntentUtils.getInstallAppIntent(file, authority, true));
    }
...
//        mContext.startActivity(IntentUtils.getUninstallAppIntent(packageName, true));
    }
...
//        }
    ...
    public static void launchApp(final String packageName)
    {
        ...
        mContext.startActivity(IntentUtils.getLaunchAppIntent(packageName, true));
    }
...
//        System.exit(0);
    ...
    {
        getAppDetailsSettings(mContext.getPackageName());
    }
    ...
    public static void getAppDetailsSettings(final String packageName)
    {
        ...
        mContext.startActivity(IntentUtils.getAppDetailsSettingsIntent(packageName, true));
    }
    ...
    {
        return getAppName(mContext.getPackageName());
    }
    ...
    {
        return getAppIcon(mContext.getPackageName());
    }
    ...
    {
        return getAppPath(mContext.getPackageName());
    }
    ...
    {
        return getAppVersionName(mContext.getPackageName());
    }
    ...
    {
        return isSystemApp(mContext.getPackageName());
    }
    ...
    {
        return getAppSignatureSHA1(mContext.getPackageName());
    }
    ...
    {
        return getAppInfo(mContext.getPackageName());
    }
