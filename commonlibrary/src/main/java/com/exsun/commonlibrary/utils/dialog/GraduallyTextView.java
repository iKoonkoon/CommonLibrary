...
//        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        if (!isStop)
        {
            ...
            {
                canvas.drawText(String.valueOf(text), 0, (int) (progress / singleDuration), 0, startY, mPaint);
            }
            //设置即将出现那个字的透明度
            mPaint.setAlpha((int) (255 * ((progress % singleDuration) / singleDuration)));
            //下一个显示出来的字的position
            int nextOne = (int) (progress / singleDuration);
