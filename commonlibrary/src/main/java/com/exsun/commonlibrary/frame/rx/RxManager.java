package com.exsun.commonlibrary.frame.rx;
...
public class RxManager
{
    ...
    public void on(String eventName, io.reactivex.functions.Consumer<Object> consumer)
    {
        // 注册
        ...
        mCompositeSubscription.add(mObservable.observeOn(AndroidSchedulers.mainThread()).subscribe(consumer, new io.reactivex.functions.Consumer<Throwable>()
        {
            @Override
